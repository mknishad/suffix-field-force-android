...
public class GroupMessageActivity extends AppCompatActivity {
  ...
  protected void onCreate(Bundle savedInstanceState) {
    ...
    LinearLayoutManager linearLayoutManager = new LinearLayoutManager(GroupMessageActivity.this);
    ...
    imgMessageSend.setOnClickListener(new View.OnClickListener() {
      ...
      public void onClick(View view) {
        ...
        if (!txtMessageInput.getText().toString().equals("")) {
          ...
          Toast.makeText(GroupMessageActivity.this, "message can not be empty", Toast.LENGTH_SHORT).show();
        }
      }
    });

    ref = FirebaseDatabase.getInstance().getReference("Group").child(groupName);
  ...
  public void sendMessage(String message) {
    ...
    hashMap.put("receiver_id", "1");
    hashMap.put("receiver", groupName);
    hashMap.put("message", message);
    hashMap.put("isseen", false);

    ref.child("GroupChats").child(groupName).push().setValue(hashMap);
...
//    });
  ...
  public void readMessage() {
    ...
    ref = FirebaseDatabase.getInstance().getReference("GroupChats").child(groupName);
...
//          }
        ...
        messageAdapter = new MessageAdapter(GroupMessageActivity.this, mchats);
